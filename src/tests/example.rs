//! Examples of chunkedge unit tests that need to test the behavior of the
//! server, and not just the logic of a single function. This module is meant to
//! be a palette of examples for how to write such tests, with various levels of
//! complexity.
//!
